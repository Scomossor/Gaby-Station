inducer-no-battery = O alvo não tem bateria!
...
inducer-set-transfer-rate = Definir {$rate} J/s
inducer-transfer-rate-set = Taxa de transferência definida para {$rate} J/s
inducer-examine-rate = Taxa de transferência atual: [color=yellow]{$rate} J/s[/color]
