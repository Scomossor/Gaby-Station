...
public sealed partial class CosmicCultComponent : Component
{
    ...
    [DataField]
    public EntProtoId SiphonAction = "ActionCosmicSiphon";

    [DataField]
    public EntProtoId CosmicFragmentationAction = "ActionCosmicFragmentation";

    [DataField]
    public EntProtoId ShopAction = "ActionCosmicShop";

    [DataField, AutoNetworkedField]
    public EntityUid? SiphonActionEntity;
    ...
    /// <summary>
    /// Actions added by bought influences, removed if you respec.
    /// </summary>
    [DataField, AutoNetworkedField]
    public List<EntityUid> BoughtActions = [];
    ...
    /// </summary>
    [DataField, AutoNetworkedField]
    public TimeSpan? CosmicGlareStun;
