...
*/
            ...
            Ignored? predicate = null)
        {
            ...
            else if (_wallMountQuery.TryComp(target, out var wallMount))
            {
                ...
                if (ignoreAnchored && _mapSystem.TryFindGridAt(targetCoords, out var gridUid, out var grid))
    ...
    /// </summary>
    [ByRefEvent]
    // Trauma - added range, which systems like extra reach can grow before the check
